...
public class MainController {
    ...
    public static NewspaperResponse getNewspaperByCategory(
            @Parameter(description = "If you want to search for the category that you like, you will type it on the input category form. You must to type " +
                    "the id of category as: 0 and 1: For the lastest new on all categories" +
                    "                       2: For Video" +
                    "                       3: For Hot News" +
                    "                       4: For Word News" +
                    "                       5: For Law News" +
                    "                       6: For Bussines News" +
                    "                       7: For Technology News" +
                    "                       8: For Car News" +
                    "                       9: For Travelling News" +
                    "                       10: For Young's life style News" +
                    "                       11: For Cultural News" +
                    "                       12: For Entertaiments News" +
                    "                       13: For Sport News" +
                    "                       14: For Education News" +
                    "                       15: For Home & Landry News" +
                    "                       16: For Health News" +
                    "                       17: For Fake/Real News" +
                    "                       18: For Reader News" )
        ...
        if (id == null || id == 0 || id == 1) {
            return GetNewspaper.getNewspapers_by_category(page, size);
        } else {
            return GetNewspaper.getNewspapers_by_category(id, page, size);
        }
        }
